...
Otra opción para recuperar información detallada sobre los errores es habilitar el registro en Omeka S. Con el registro habilitado, Omeka S escribirá los detalles de todos los errores en un archivo. Cualquier página del tipo «Omeka S ha detectado un error» tendrá sus detalles registrados, y también se puede registrar información adicional de depuración o advertencias. 
...
Los errores se registrarán en el archivo `logs/application.log`. Si deseas cambiar esta ruta por otra, añade una línea debajo de `'log' => true,` con el formato
...
A continuación, podrás ver o descargar ese archivo en cualquier momento para comprender los errores a medida que se registran. 
