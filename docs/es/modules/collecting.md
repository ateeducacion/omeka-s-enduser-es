...
La página «Añadir formulario de recogida» tiene dos secciones: la primera contiene un conjunto de campos y opciones que debes completar; la segunda es donde añades y editas las preguntas que conformarán el formulario que verán y rellenarán los visitantes del sitio.
...
**Archivos multimedia** permite a los visitantes añadir archivos multimedia a su envío.
...
- Un menú desplegable para el tipo de archivo multimedia, con las siguientes opciones:
  ...
  - Subir varios, que permite a los usuarios subir varios archivos a la vez utilizando el selector de archivos nativo del navegador (con las teclas Mayús o Ctrl)
	- Si tienes instalado [Mapping](../modules/mapping.md), puedes añadir un mapa que permita a los usuarios indicar ubicaciones haciendo clic directamente en el mapa e introduciendo una etiqueta en el campo situado justo debajo. Si el campo debajo del mapa se deja en blanco, el marcador se etiquetará con el contenido del campo «Título».
![La página pública «Recopilación» incluye un mapa para seleccionar una ubicación. Un campo situado justo debajo del mapa permite a los usuarios introducir la etiqueta del marcador.](modulesfiles/collecting_map.png)
  - URL
  - HTML.
...
**Condiciones de uso** es un campo de varias líneas en el que puedes introducir las condiciones de uso del material recopilado a través de este sitio. Este texto está enlazado desde el formulario, justo encima del botón de envío:
...
Cuando actualices el estado de un elemento de «Necesita revisión» a «Público» o «Privado», tu nombre aparecerá en la fila de ese elemento como el usuario que lo ha revisado. Si hay varias personas trabajando en un sitio, esto puede ayudarte a llevar un control de quién ha aprobado los elementos recopilados.
