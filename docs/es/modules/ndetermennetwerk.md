...
### [Red de Términos del Patrimonio Digital Neerlandés: NDE Termennetwerk](https://termennetwerk.netwerkdigitaalerfgoed.nl/){target=_blank} (`nl`)

- Tesauro de Arte y Arquitectura - materiales
- Tesauro de Arte y Arquitectura - procesos y técnicas
- Tesauro de Arte y Arquitectura - estilos y períodos
...
- Homosaurus
- Iconclass
- Tesauro del Patrimonio Indio
- Música: géneros y estilos
- Música: personas y grupos
- Tesoros musicales: temas
- Tesauro neerlandés de nombres de autores
- RKDartists
- STCN: impresores
- Tesauro del Museo Nacional de Culturas del Mundo
