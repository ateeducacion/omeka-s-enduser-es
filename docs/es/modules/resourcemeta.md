...
Haz clic en el icono del lápiz que aparece en cada plantilla para modificar su configuración de metadatos. Se te redirigirá a una pantalla con todas las propiedades de la plantilla de recursos, con un menú desplegable para seleccionar entre los elementos meta disponibles. 
