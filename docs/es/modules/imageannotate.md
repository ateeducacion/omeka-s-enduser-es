...
El [módulo de anotación de imágenes](https://omeka.org/s/modules/ImageAnnotate/){target=_blank} permite a los usuarios del sitio adjuntar información a coordenadas en archivos de imagen, incluidos [recursos de instalación](../admin/assets.md) y [archivos multimedia adjuntos a elementos](../content/media.md). 

Este módulo añade una nueva pestaña «Anotar imagen» a la interfaz de edición de archivos multimedia en el panel de administración, donde se puede dibujar sobre la imagen seleccionada. Los usuarios pueden dibujar rectángulos y añadir leyendas de texto específicas para cada área. También añade nuevos [bloques de recursos](../sites/site_theme.md#configure-resource-pages) para que las anotaciones se puedan ver en las páginas de visualización de elementos y archivos multimedia, y nuevos [bloques de página](../sites/site_pages.md#page-blocks) para que las anotaciones se puedan añadir y mostrar en las páginas del sitio. 

![Una página pública que muestra una imagen con una anotación. La imagen tiene dos selecciones rectangulares alrededor de las personas que aparecen en la fotografía; una es un rectángulo amarillo que indica que está activa, y una ventana emergente muestra el texto «Pilot James Ray» y un botón que dice «Cerrar».](modulesfiles/imageAnnotate_publicPage.png)

En el caso de los archivos multimedia que generan miniaturas de imagen (como los PDF, que obtienen una miniatura de la primera página), puedes añadir anotaciones a la miniatura a tamaño completo que crea Omeka S. Ten en cuenta que, aunque puedes añadir anotaciones a elementos como las miniaturas de vídeo, tus anotaciones solo se verán en determinados contextos en los que no se muestre el archivo multimedia original. 

Dependiendo de tu objetivo, puedes anotar los propios archivos multimedia adjuntos a los elementos, de modo que las anotaciones estén disponibles en toda la instalación, o bien anotar los archivos multimedia únicamente en el contexto de una página específica del sitio. Valora si deseas que la anotación esté ampliamente disponible (por ejemplo, para identificar a todas las personas de una fotografía) o si prefieres que se limite al contexto de una exposición o un ensayo (por ejemplo, para señalar a una persona concreta de interés). Si lo deseas, puedes combinar las anotaciones multimedia con las anotaciones específicas de cada página.
...
Cualquiera que tenga permiso para editar una página puede añadir bloques de página. 
...
![La página de administración de un elemento multimedia, en la pestaña «Anotar imagen», sin ninguna anotación establecida aún en la imagen.](modulesfiles/imageAnnotate_mediaEdit.png)

Puedes anotar imágenes con selecciones rectangulares, que pueden ser tan grandes o pequeñas como desees. Cuando se cree un rectángulo, introduce un texto de anotación. Es necesario introducir un texto de anotación para guardar la anotación. Asegúrate de guardar la anotación en la imagen y, a continuación, guarda la página.

![La misma página, con dos rectángulos seleccionados. A uno se le ha añadido texto como anotación: «Senador Hiram Bingham». Hay un botón «Cancelar» y un botón «Aceptar» para guardar la anotación.](modulesfiles/imageAnnotate_mediaEdit2.png)
...
![La misma página, guardada (no en modo de edición), con un banner verde que dice «Medio actualizado correctamente» y los dos rectángulos visibles en la imagen.](modulesfiles/imageAnnotate_mediaSaved.png)

Si deseas modificar las anotaciones existentes, puedes volver a editar el archivo multimedia y modificar o eliminar las anotaciones que se han guardado. Puedes eliminar anotaciones individuales con el icono rojo de la papelera, o hacer clic en el botón «Restablecer anotaciones» para eliminar todas las anotaciones. 

![La misma página y pestaña, en modo de edición, con un rectángulo resaltado en amarillo y su anotación visible. En la ventana emergente de la anotación aparece ahora un icono rojo de papelera. El cursor se encuentra sobre el botón, mostrando la descripción emergente «Eliminar». También aparece un botón «Restablecer anotaciones» debajo de la imagen.](modulesfiles/imageAnnotate_mediaReset.png)
...
En la pestaña «Página de recursos multimedia», verás un nuevo bloque llamado «Visualización de recursos multimedia (con anotaciones en imágenes)». Si sustituyes el bloque normal «Visualización de recursos multimedia» por este bloque, se mostrarán las anotaciones en las imágenes cuando estén disponibles; de lo contrario, los recursos multimedia aparecerán en las páginas de visualización de recursos multimedia como de costumbre. 

![La configuración de la página de recursos multimedia, donde «Representación de medios (con anotaciones en imágenes)» aparece como un bloque encima de «Representación de medios» y «Galería Lightbox», que están en rojo ya que se van a eliminar de la página.](modulesfiles/imageAnnotate_resourceMedia.png)

Cuando haya anotaciones de imagen disponibles, aparecerá un botón en las páginas de visualización de elementos públicos y de recursos multimedia con el texto «Ver anotaciones». Este botón aparecerá debajo de cada imagen que tenga anotaciones. Al hacer clic en él, se mostrarán las anotaciones (que están ocultas por defecto) y el botón cambiará a «Ver sin anotaciones». 

![El recurso multimedia con sus anotaciones, mostrado en la página de vista del elemento. Debajo de la imagen hay un botón negro con el texto «Ver sin anotaciones».](modulesfiles/imageAnnotate_publicResource.png)
...
En el caso de los vídeos y los PDF, el botón «Ver anotaciones» aparecerá junto a la visualización multimedia habitual y, al hacer clic en él, el contenido multimedia se sustituirá por su miniatura con anotaciones. Módulos como «PDF Embed» pueden determinar si se muestra el fotograma del contenido multimedia o su miniatura en lugares como la página de visualización del elemento o del contenido multimedia. 

### Bloques de página

Este módulo añade dos bloques de página: «Anotar imagen de recurso» y «Anotar imagen de multimedia». 
...
![El recurso con sus anotaciones —tanto las dos configuradas en el propio recurso como las del bloque de página— mostradas en una página con el título del elemento y un pie de foto.](modulesfiles/imageAnnotate_publicPage2.png)
