...
El Conector de repositorios de datos añade una entrada en el menú Módulos de la izquierda. Al hacer clic en el nombre del módulo o en el icono del signo más situado a la izquierda, el menú se expandirá para mostrar enlaces a las cuatro opciones de importación. El módulo se abre en la página Importaciones anteriores de forma predeterminada.

![Menú de navegación que muestra las opciones del Conector de repositorios de datos](../modules/modulesfiles/datarepoconnect_tabs.png)
...
+ **Límite**: El número máximo de resultados que se recuperarán en un solo lote. Si observa errores o datos que faltan, intente reducir este número. Aumentarlo podría acelerar las importaciones. (Este campo es obligatorio. El valor predeterminado es 100.)
+  **Importación de prueba**: Si se marca, el conector importará ÚNICAMENTE el número de resultados indicado en el campo Límite anterior. Esto resulta útil para obtener una vista previa de la asignación de metadatos desde la fuente a Omeka S y para garantizar que la conexión funciona.
...
![La pantalla de importación de Dataverse que muestra las opciones que se enumeran a continuación.](../modules/modulesfiles/datarepoconnect_options.png)
...
+ **ID de la comunidad Zenodo**: La cadena corta que identifica de qué comunidad de Zenodo se va a importar. Se encuentra en la URL después de «https://zenodo.org/communities/» y antes de cualquier parámetro de búsqueda. (Este campo es obligatorio.)
...
Si selecciona Invenio, verá una pantalla con las siguientes opciones:
...
Haz clic en «Conector de repositorio de datos» en el menú de navegación de la izquierda del panel de administración, lo que abrirá la página «Importaciones anteriores».

La tabla de importaciones anteriores incluye: 

- columnas para **deshacer** y **reejecutar** trabajos anteriores,
...
Si una importación concreta se ha deshecho o se ha vuelto a ejecutar, la columna «Estado» lo indicará. Puede ver un subconjunto de los elementos afectados de cada tarea haciendo clic en el enlace «Total» debajo de la columna «Elementos».
...
Vaya a la página Importaciones anteriores. En la columna «Volver a ejecutar», marque la casilla correspondiente a cada importación que desee actualizar y, a continuación, pulse «Enviar». 
...
Puedes deshacer una importación completada y eliminar todos los elementos asociados en cualquier momento. Esto borrará por completo esos elementos y cualquier edición de metadatos que hayas realizado en ellos. 

Ve a la página Importaciones anteriores. En la columna «Deshacer», marca la casilla de cada importación que desees deshacer y, a continuación, haz clic en «Enviar».
