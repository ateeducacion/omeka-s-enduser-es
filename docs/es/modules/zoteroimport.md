...
Para poder importar desde una biblioteca de Zotero, debes tener acceso a la API de la biblioteca. Para utilizar la importación de Zotero, necesitarás el ID del grupo o del usuario:
...
Es posible que también necesites el ID de una colección concreta y una clave API para importar archivos. 
...
* Marca la casilla de verificación para importar archivos. La clave API es necesaria para importar archivos.
	* Las capturas de pantalla de páginas HTML se importarán como archivos ZIP. 
*  La opción «Añadidos después de» te permite importar únicamente aquellos elementos de Zotero añadidos a la biblioteca después de la fecha y hora que elijas. Puedes utilizar esta opción para actualizar a partir de una importación anterior sin volver a añadir los archivos que ya habías importado.
...
La página «Importaciones anteriores» muestra una tabla con las importaciones anteriores, tanto las que se han realizado con éxito como las que han fallado por un error o las que se han deshecho. La tabla contiene las siguientes columnas:
