...
Esta función contribuye a fomentar la coherencia en la introducción de metadatos y la compatibilidad de los datos con otras bases de datos. Ten en cuenta que Value Suggest ofrece, pero no puede exigir, términos procedentes de la función de sugerencia automática. Los usuarios siempre tendrán la opción de crear su propio valor de texto en su lugar.
...
Al hacer clic en el título de una plantilla de recurso para ver sus detalles, el vocabulario «Value Suggest» aparecerá bajo el encabezado de la tabla «Tipo de datos».
...
- La base de datos geográfica GeoNames
...
### [Nomenclatura para la catalogación museística](https://page.nomenclature.info/apropos-about.app?lang=en){target=_blank}
...
- El Fichero de Autoridad Internacional Virtual (VIAF)
