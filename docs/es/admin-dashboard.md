...
El panel de control administrativo gestiona el contenido compartido por todos los sitios de Omeka S y las funcionalidades principales de la instalación de Omeka S. 
...
El cuadro **Gestionar sitios** muestra la lista de [Sitios](sites/index.md) de la instalación. Al hacer clic en el nombre de un sitio, accederás a la pestaña de administración de dicho sitio; al hacer clic en el pequeño icono de flecha situado a la derecha, accederás a la vista pública del sitio (en una nueva ventana o pestaña). 
...
La barra de navegación de la izquierda del panel de control se divide en secciones relacionadas con la funcionalidad y el acceso de los usuarios:
...
- Recursos: creación de contenidos y gestión de metadatos.
...
En esta página puedes comprobar las versiones de las dependencias que utiliza Omeka, como PHP, ImageMagick y MySQL. Si un módulo concreto requiere que tu servidor proporcione algo, como una utilidad de PHP, puedes buscarlo aquí. También puedes consultar esta sección para comprobar si tu instalación de Omeka reconoce un módulo que hayas intentado instalar.
